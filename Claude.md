...
AI agents must not create, edit, delete, rename, move, generate, or reorganize documentation of any kind, except for README.md, however, the readme.md can only include information regrading setup and project introduction.
