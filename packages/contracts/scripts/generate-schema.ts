...
const REGISTRY: Record<string, z.ZodTypeAny> = {
  ...
  "invocation-propose-generative-ui-plan": ProposeGenerativeUiPlanInvocationSchema,
  "success-result-propose-generative-ui-plan": ProposeGenerativeUiPlanSuccessResultSchema,
