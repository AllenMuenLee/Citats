...
describe("generated UI runtime authority", () => {
  it("emits a revision-bound opaque command only for an allowed capability", () => {
    const commands: unknown[] = [];
    const capability = { id: opaque("cap-1"), allowedCommandKinds: ["activate"] as const };
    const runtime = {
    ...
    expect(commands).toEqual([{ kind: "activate", capabilityId: "cap-1", revision: 7, arguments: { index: 2 } }]);
