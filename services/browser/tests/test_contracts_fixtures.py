...
FIXTURE_MODEL_REGISTRY: dict[str, type[BaseModel]] = {
    ...
    "invocation-explore-website": InvocationExploreWebsite,
    "success-result-explore-website": SuccessResultExploreWebsite,
    "invocation-get-page-understanding-slice": InvocationGetPageUnderstandingSlice,
    "success-result-get-page-understanding-slice": SuccessResultGetPageUnderstandingSlice,
    "invocation-propose-generative-ui-plan": InvocationProposeGenerativeUiPlan,
    "success-result-propose-generative-ui-plan": SuccessResultProposeGenerativeUiPlan,
