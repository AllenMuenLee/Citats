...
/**
 * Serves the display-safe, plan-derived props for one mounted instance
 * (P04-F04 step 2).
 *
 ...
 * inbound `init` message. Nothing here carries the plan itself, the
 * captured HTML, the generated source, or any prompt -- only what the
 * instance store already projected for display.
 */
  ...
  return NextResponse.json(
    {
      ...
      planDigest: instance.planDigest,
