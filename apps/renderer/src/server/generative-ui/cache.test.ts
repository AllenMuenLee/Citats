...
function artifact(valid = true) { return { schemaVersion: 1, artifactId: `gui_${"c".repeat(64)}`, module: { kind: "bytes", encoding: "base64", value: "YQ==" }, manifest: { observationIds: ["obs-1"], sourceIds: [], recordIds: [], mediaIds: [], capabilityIds: [], emittedCommandKinds: [], localInteractions: [], accessibilityFeatures: [], responsiveRegions: [], runtimeImports: [], fallback: false }, validation: { valid, issues: valid ? [] : [{ code: "INVALID", severity: "error", location: null }] }, sourceMapPolicy: "omitted", inputDigest: identity.inputDigest, promptDigest: identity.promptDigest, modelDigest: "d".repeat(64), toolchainDigest: "e".repeat(64), expiresAt: "2030-01-01T00:00:00Z", fallbackText: null }; }
